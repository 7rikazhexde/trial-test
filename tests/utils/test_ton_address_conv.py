...
from project_a.utils import ton_address_conv
...
def test_load_config_success(
    ...
    """
    mocker.patch(
        "project_a.utils.ton_address_conv.load_config",
        return_value=mock_config,
    )
    mocker.patch("project_a.utils.ton_address_conv.Address", return_value=mock_address)
...
def test_missing_address_config(
    ...
    :param capsys: 標準出力をキャプチャするフィクスチャ
    """
    mocker.patch("project_a.utils.ton_address_conv.load_config", return_value={})
...
def test_invalid_address(
    ...
    mocker.patch(
        "project_a.utils.ton_address_conv.Address",

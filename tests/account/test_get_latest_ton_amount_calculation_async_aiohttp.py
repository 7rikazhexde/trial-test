...
import project_a.account.get_latest_ton_amount_calculation_async_aiohttp as gltacaa
from project_a.account.get_latest_ton_amount_calculation_async_aiohttp import (
    TraceConfig,
)
...
def mock_address(mocker: MockerFixture) -> None:
    ...
    mocker.patch(
        "project_a.account.get_latest_ton_amount_calculation_async_aiohttp.Address",

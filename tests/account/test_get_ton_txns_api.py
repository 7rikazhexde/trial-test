...
from project_a.account import get_ton_txns_api
...
def test_get_transactions_v3(
    ...
    mocker.patch(
        "project_a.account.get_ton_txns_api.requests.get",
        return_value=mock_response,
    )

    mock_save_json = mocker.patch("project_a.account.get_ton_txns_api.save_json_file")
...
def test_main(
    ...
    """
    mocker.patch(
        "project_a.account.get_ton_txns_api.load_config",
        return_value=mock_config,
    )
    mocker.patch(
        "project_a.account.get_ton_txns_api.get_transactions_v3",

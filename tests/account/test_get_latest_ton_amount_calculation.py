...
import project_a.account.get_latest_ton_amount_calculation as glta
...
def mock_address(mocker: MockerFixture) -> None:
    ...
    mocker.patch(
        "project_a.account.get_latest_ton_amount_calculation.Address",
...
#    """
#    mocker.patch(
#        "project_a.account.get_latest_ton_amount_calculation.DEFAULT_COUNTER_VAL", "USD"
#    )
#    mocker.patch(
#        "project_a.account.get_latest_ton_amount_calculation.get_currency_symbol",
#        return_value="$",
#    )
#    mocker.patch(
#        "project_a.account.get_latest_ton_amount_calculation.Locale",
...
#    日本円の通貨記号を取得する場合のテスト
#    """
#    mocker.patch('project_a.account.get_latest_ton_amount_calculation.DEFAULT_COUNTER_VAL', 'JPY')
#    mocker.patch('project_a.account.get_latest_ton_amount_calculation.get_currency_symbol', return_value='￥')
#    mocker.patch('project_a.account.get_latest_ton_amount_calculation.Locale', return_value=Locale('ja_JP'))
#
#    # symbolを直接再評価

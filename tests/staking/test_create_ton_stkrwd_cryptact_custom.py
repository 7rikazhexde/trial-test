...
from project_a.staking.create_ton_stkrwd_cryptact_custom import (
...
def test_create_cryptact_custom_csv(
    ...
    mocker.patch(
        "project_a.staking.create_ton_stkrwd_cryptact_custom.project_root",
        tmp_path,
    )

    output_dir = tmp_path / "project_a" / "output"
...
#    """
#    mocker.patch(
#        "project_a.staking.create_ton_stkrwd_cryptact_custom.load_config",
#        return_value=mock_config,
#    )
#    mocker.patch(
#        "project_a.staking.create_ton_stkrwd_cryptact_custom.get_transactions_v3",
#        return_value=sample_transactions,
#    )
#    mock_create_csv = mocker.patch(
#        "project_a.staking.create_ton_stkrwd_cryptact_custom.create_cryptact_custom_csv"
#    )
#    mock_print = mocker.patch("builtins.print")
#
#    main()
